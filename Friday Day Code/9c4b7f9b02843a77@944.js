...
md`# The Music Festival Gender Problem`
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`Major Music festivals have a gender inequality problem. Of all the acts booked, the majority of the artists and band members are male. The following is a representation of the data compiled by Book More Women, comparing all-male acts with acts featuring at least one female or non-binary member.`
)});
